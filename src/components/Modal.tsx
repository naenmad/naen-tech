...
const ProjectCardModal: FC<ProjectCardModalProps> = ({ title, description, link }) => {
            ...
            <div className="flex justify-end space-x-4">
              {link && (
                <a
                  ...
                  className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 font-medium hover:bg-blue-700 transition-colors duration-200"
                >
                  Live Demo
